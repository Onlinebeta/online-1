...
#include "config/online-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatOnlineURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + OnlineUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatOnlineURI(info));
}
