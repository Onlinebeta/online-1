...
#ifndef ONLINE_QT_ONLINEUNITS_H
#define ONLINE_QT_ONLINEUNITS_H
...
/** Online unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class OnlineUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit OnlineUnits(QObject *parent);

    /** Online units.
      @note Source: https://en.online.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ONE,
...
typedef OnlineUnits::Unit OnlineUnit;

#endif // ONLINE_QT_ONLINEUNITS_H
