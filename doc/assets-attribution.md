The following is a list of assets used in the online source and their proper attribution.
...
* License: MIT
* Site: [https://onlinetalk.org/index.php?topic=15276.0](https://onlinetalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original online logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/online.icns, src/qt/res/src/online.svg,
	src/qt/res/src/online.ico, src/qt/res/src/online.png,
	src/qt/res/src/online_testnet.png, docs/online_logo_doxygen.png,
