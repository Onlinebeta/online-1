Online-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/online/files/Online/online-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Online
...
New/changed settings (command-line or online.conf file)
--------------------------------------------------------
