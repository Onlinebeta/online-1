Download URL: https://sourceforge.net/projects/online/files/Online/online-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ONE fee schedule (users still pay 0.01 ONE per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #online00 - #online99
