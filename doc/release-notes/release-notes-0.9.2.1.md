Online Core version 0.9.2.1 is now available from:

  https://online.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ONE to 0.01 ONE
...
- Fix "Start online on system login"
