Online version 0.5.4 is now available for download at:
http://sourceforge.net/projects/online/files/Online/online-0.5.4/
...
http://gitorious.org/online/onlined-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Online-Qt notifications under Growl 1.3.
Increase required age of Online-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOnline properly when installing Online-Qt over it. (Windows)
