Online Core version 0.9.4 is now available from:

  https://online.org/bin/0.9.4/
...
this update is incompatible with the Online system and could lead to consensus
forks.

Online Core released binaries from https://online.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~online/+archive/ubuntu/online
- A third-party or self-compiled Online Core

upgrade to Online Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
