...
This document provides guidelines for internationalization of the Online Core software. 
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `online_en.ts` remains unchanged.
