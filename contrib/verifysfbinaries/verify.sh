...
###   This script attempts to download the signature file SHA256SUMS.asc from online.org
...
WORKINGDIR="/tmp/online"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://online.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://online.org/bin/"
VERSIONPREFIX="online-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'online-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[online-]<version>-[rc[0-9]] (example: online-0.9.2-rc1)"
   echo "wget output:"
