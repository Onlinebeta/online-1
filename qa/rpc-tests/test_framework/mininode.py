# mininode.py - Online P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a online node
...
# Objects that map to onlined objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in onlined indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest"):
        ...
        print 'MiniNode: Connecting to Online Node IP # ' + dstaddr + ':' \
            + str(dstport)
